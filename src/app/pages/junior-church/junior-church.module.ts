...
import { JuniorChurchUpdateChildAttendanceModalComponent } from './junior-church-check-in/junior-church-attendance-detail/modals/update-child-attendance-modal/update-child-attendance-modal.component';
...
@NgModule({
  ...
  declarations: [
    ...
    JuniorChurchUpdateChildAttendanceModalComponent,
