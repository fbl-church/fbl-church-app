...
@Component({
  selector: 'app-awana-children-detail',
  templateUrl: './awana-children-detail.component.html',
})
export class AwanaChildrenDetailComponent implements OnInit, OnDestroy {
